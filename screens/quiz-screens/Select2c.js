...
export default function Select2c({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.option}
        onPress={() => Linking.openURL("https://www.raise.sg/reimagine.html")}
      >
        <Text style={styles.optionText}>raiSE REIMAGINE Programme</Text>
