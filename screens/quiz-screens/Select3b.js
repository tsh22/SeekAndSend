...
export default function Select3b({ navigation }) {
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          Linking.openURL(
            "https://www.raise.sg/social-enterprise-devlopment-fundamentals/"
          )
        }
      >
      ...
      <TouchableOpacity
        style={styles.option}
        onPress={() => Linking.openURL("https://www.raise.sg/leapforgood/")}
      >
        <Text style={styles.optionText}>LeapForGood</Text>
        <Text style={styles.whiteItalics}>(Click to learn more!)</Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.option}
      ...
      <TouchableOpacity
        style={styles.option}
        onPress={() => Linking.openURL("https://www.raise.sg/incubation/")}
      >
        <Text style={styles.optionText}>raiSE Incubation Programme</Text>
        <Text style={styles.whiteItalics}>(Click to learn more!)</Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.option}
      ...
      <TouchableOpacity
        style={styles.option}
        onPress={() => Linking.openURL("https://www.raise.sg/resources.html")}
      >
        <Text style={styles.optionText}>Toolkits {"&"} Online Resources</Text>
        <Text style={styles.whiteItalics}>(Click to learn more!)</Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.button}
